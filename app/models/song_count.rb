...
class SongCount < ActiveRecord::Base
  ...
  validates :count, numericality: {greater_than_or_equal_to: 1, less_than_or_equal_to: 30},
    if: :count
  validates :song_id, uniqueness: {scope: :concert} # rubocop:disable Rails/UniqueValidationWithoutIndex

  ...
  context "active_years" do
    ...
    context "assuming it is the summer of 2020" do
      ...
      it "counts only years with membership" do
        expect do
          create_role(Group::VereinJodler::Mitglied, start_date: "2018-02-01",
            end_date: "2018-04-30")
          create_role(Group::VereinJodler::Mitglied, start_date: "2018-12-01",
            end_date: "2019-07-31")
          subject.update_active_years
        end.to change(subject, :active_years).to(2)
      end
      ...
      it "counts years which have an short interruption fully" do
        expect do
          create_role(Group::VereinJodler::Mitglied, start_date: "2018-02-01",
            end_date: "2018-04-30")
          create_role(Group::VereinJodler::Mitglied, start_date: "2019-01-01",
            end_date: "2019-10-31")

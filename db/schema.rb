...
ActiveRecord::Schema[7.1].define(version: 2025_05_27_090212) do
  ...
  create_table "concerts", id: :serial, force: :cascade do |t|
    t.string "name", null: false
    t.integer "verein_id", null: false
    t.integer "mitgliederverband_id"
    t.integer "song_census_id"
    t.date "performed_at"
    ...
    t.string "reason"
    t.index ["deleted_at"], name: "index_concerts_on_deleted_at"
    t.index ["mitgliederverband_id"], name: "index_concerts_on_mitgliederverband_id"
  end
  ...
  create_table "people", id: :serial, force: :cascade do |t|
    ...
    t.integer "active_years"
    t.boolean "active_role", default: false, null: false
    t.boolean "personal_data_usage", default: false, null: false
  ...
  create_table "song_censuses", id: :serial, force: :cascade do |t|
    t.integer "year", null: false
    t.date "start_at"
    t.date "finish_at"
    t.index ["year"], name: "index_song_censuses_on_year"
  end

  create_table "song_counts", id: :serial, force: :cascade do |t|
  ...
  create_table "songs", id: :serial, force: :cascade do |t|
    ...
    t.integer "suisa_id"
    t.index ["suisa_id"], name: "index_songs_on_suisa_id", unique: true
  end
  ...
  add_foreign_key "song_counts", "concerts"
